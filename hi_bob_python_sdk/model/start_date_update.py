...
class StartDateUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["startDate", "reason", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["startDate", "reason", ], str]):
