...
class Task(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "description", "id", "set", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "description", "id", "set", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        set: typing.Union[MetaOapg.properties.set, str, schemas.Unset] = schemas.unset,
