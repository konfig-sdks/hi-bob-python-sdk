...
class AddDocument(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def tags() -> typing.Type['AddDocumentTags']:
                return AddDocumentTags
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tags"]) -> 'AddDocumentTags': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tags", "documentName", "documentUrl", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tags"]) -> typing.Union['AddDocumentTags', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tags", "documentName", "documentUrl", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        tags: typing.Union['AddDocumentTags', schemas.Unset] = schemas.unset,
