...
class BaseApi(api_client.Api):
    ...
    def _delete_equity_grant_mapped_args(
        self,
        id: str,
        entry_id: int,
    ...
    async def _adelete_equity_grant_oapg(
        self,
...
class DeleteEquityGrantRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_equity_grant(
        self,
        id: str,
        entry_id: int,
        **kwargs,
        ...
        args = self._delete_equity_grant_mapped_args(
            id=id,
            entry_id=entry_id,
        )
        return await self._adelete_equity_grant_oapg(
    ...
    def delete_equity_grant(
        ...
        return self._delete_equity_grant_oapg(
            path_params=args.path,
        )

class DeleteEquityGrant(BaseApi):
    ...
    async def adelete_equity_grant(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_equity_grant(
            id=id,
            entry_id=entry_id,
            **kwargs,
        )
    ...
    def delete_equity_grant(
        ...
        raw_response = self.raw.delete_equity_grant(
            id=id,
            entry_id=entry_id,
        )
