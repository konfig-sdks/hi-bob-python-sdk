...
class BaseApi(api_client.Api):
    ...
    def _delete_salary_entry_mapped_args(
        self,
        id: str,
        entry_id: int,
    ...
    async def _adelete_salary_entry_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{id}/salaries/{entry_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeleteSalaryEntryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_salary_entry(
        self,
        id: str,
        entry_id: int,
        **kwargs,
        ...
        args = self._delete_salary_entry_mapped_args(
            id=id,
            entry_id=entry_id,
        )
        return await self._adelete_salary_entry_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_salary_entry(
        self,
        id: str,
        entry_id: int,
    ) -> typing.Union[
        ...
        return self._delete_salary_entry_oapg(
            path_params=args.path,
        )

class DeleteSalaryEntry(BaseApi):
    ...
    async def adelete_salary_entry(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_salary_entry(
            id=id,
            entry_id=entry_id,
            **kwargs,
        )
    ...
    def delete_salary_entry(
        ...
        raw_response = self.raw.delete_salary_entry(
            id=id,
            entry_id=entry_id,
        )
