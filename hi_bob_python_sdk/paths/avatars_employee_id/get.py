...
class BaseApi(api_client.Api):
    ...
    def _get_avatar_url_mapped_args(
        self,
        employee_id: str,
    ...
    async def _aget_avatar_url_oapg(
        self,
...
class GetAvatarUrlRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_avatar_url(
        self,
        employee_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_avatar_url_mapped_args(
            employee_id=employee_id,
        )
        return await self._aget_avatar_url_oapg(
    ...
    def get_avatar_url(
        ...
        return self._get_avatar_url_oapg(
            path_params=args.path,
        )

class GetAvatarUrl(BaseApi):
    ...
    async def aget_avatar_url(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_avatar_url(
            employee_id=employee_id,
            **kwargs,
        )
    ...
    def get_avatar_url(
        ...
        raw_response = self.raw.get_avatar_url(
            employee_id=employee_id,
        )
