...
class BaseApi(api_client.Api):
    ...
    def _get_email_avatar_mapped_args(
        self,
    ...
    async def _aget_email_avatar_oapg(
        self,
...
class GetEmailAvatarRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_email_avatar(
        self,
        email: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_email_avatar_mapped_args(
            email=email,
        )
        return await self._aget_email_avatar_oapg(
    ...
    def get_email_avatar(
        ...
        return self._get_email_avatar_oapg(
            query_params=args.query,
        )

class GetEmailAvatar(BaseApi):
    ...
    async def aget_email_avatar(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_email_avatar(
            email=email,
            **kwargs,
        )
    ...
    def get_email_avatar(
        ...
        raw_response = self.raw.get_email_avatar(
            email=email,
        )
