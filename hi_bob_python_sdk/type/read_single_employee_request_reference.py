...
class RequiredReadSingleEmployeeRequestReference(TypedDict):
    pass

class OptionalReadSingleEmployeeRequestReference(TypedDict, total=False):
    fields: ReadSingleEmployeeRequestReferenceFields
...
class ReadSingleEmployeeRequestReference(RequiredReadSingleEmployeeRequestReference, OptionalReadSingleEmployeeRequestReference):
    pass
